 ...
 * @author jbannon
 */
public class Logarithm extends Function_Properties {
    
    private final List<Logarithm> Logs = new ArrayList<>();
    ...
    public Logarithm(final String theEquation) throws ParseException {
        ...
        for (char c : logArray) {
            ...
            else if ((c == 'l' || c == 'L') && !verified && index + 3 < logArray.length
                && (logArray[index + 1] == 'o' || logArray[index + 1] == 'O')
                && (logArray[index + 2] == 'g' || logArray[index + 2] == 'G')
                && (logArray[index + 3] == '(')) 
                    verified = true;
